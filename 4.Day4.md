...
- _**11:30 - 12:30**_ [Docker/Singularity](4.Day4.md#4-nextflow--docker--singularity-containers), [Executors](4.Day4.md#5-executors) and [Channel Operations](4.Day4.md#6-channel-operations)
...
- The **slides** of the talk are available [**here**](files/slides/nexflow_tutorial.pdffiles/slides/nextflow_tutorial.pdf).
...
```bash
wget https://github.com/fpsom/CODATA-RDA-Advanced-Bioinformatics-2019/blob/master/files/data/tutorial.zip
unzip tutorial.zip
```
